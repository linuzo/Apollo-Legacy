...
use darksystem\phpseclib\Crypt\DES;
...
class SSH1
{
    ...
    */
    ...
    function _connect()
    {
        ...
        $server_key_public_exponent = new Integer($this->_string_shift($response[self::RESPONSE_DATA], ceil($temp['len'] / 8)), 256);
        ...
        $temp = unpack('nlen', $this->_string_shift($response[self::RESPONSE_DATA], 2));
        $server_key_public_modulus = new Integer($this->_string_shift($response[self::RESPONSE_DATA], ceil($temp['len'] / 8)), 256);
        ...
        $temp = unpack('nlen', $this->_string_shift($response[self::RESPONSE_DATA], 2));
        $host_key_public_exponent = new Integer($this->_string_shift($response[self::RESPONSE_DATA], ceil($temp['len'] / 8)), 256);
        ...
        $temp = unpack('nlen', $this->_string_shift($response[self::RESPONSE_DATA], 2));
        $host_key_public_modulus = new Integer($this->_string_shift($response[self::RESPONSE_DATA], ceil($temp['len'] / 8)), 256);
