...
namespace darksystem\behaviorpacks;
	...
	public function __construct(Server $server, string $path){
		...
		if(Translate::checkTurkish() === "yes"){
			if(!file_exists($this->path . "behavior_paketleri.yml")){
				file_put_contents($this->path . "behavior_paketleri.yml", file_get_contents($this->server->getFilePath() . "src/darksystem/resources/behavior_paketleri.yml"));
			}
			...
			if(!file_exists($this->path . "behavior_packs.yml")){
				file_put_contents($this->path . "behavior_packs.yml", file_get_contents($this->server->getFilePath() . "src/darksystem/resources/behavior_packs.yml"));
			}
