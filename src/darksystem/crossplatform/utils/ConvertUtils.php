...
class ConvertUtils{
	 ...
	 */
	public static function convertNBTDataFromPEtoPC(Tag $nbt, $isListTag = false){
	 ...
	 */
	public static function convertNBTDataFromPCtoPE($buffer, $isListTag = false, $listTagId = NBT::TAG_End){
	 ...
	 * @param Item &$item
	 */
	public static function convertItemData($iscomputer, Item &$item){
	 ...
	 */
	public static function convertPEToPCMetadata($olddata){
		$newdata = [];
	 ...
	 * #blamemojang
	 */
	private static function convertTrapdoor(&$blockdata){
		//swap bits
...
class ComputerItem extends Item{
	 ...
	 */
	public function __construct($id = 0, $meta = 0, $count = 1, $tag = ""){
