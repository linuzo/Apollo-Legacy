...
class MossStone extends Populator {
	...
	public function populate(ChunkManager $level, $chunkX, $chunkZ, Random $random){
		...
		for($i = 0; $i < $amount; ++$i){
			...
			if($y !== -1 and $this->canMossStoneStay($x, $y, $z)){
				$this->level->setBlockIdAt($x, $y, $z, BlockFactory::MOSS_STONE);
	...
	private function canMossStoneStay($x, $y, $z){
		...
		return ($b === BlockFactory::AIR or $b === BlockFactory::SNOW_LAYER) and $this->level->getBlockIdAt($x, $y - 1, $z) === BlockFactory::PODZOL;
	}
