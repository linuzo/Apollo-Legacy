...
class Main extends PluginBase implements Listener{
	...
	public function onEnable(){
		...
		$this->waitingTests = [
			...
			new tests\Issue1145_ItemEqualsTest($this),
			new tests\AsyncTaskMainLoggerTest($this),
			new tests\RegisterNewBlockTest($this),
			new tests\RegisterCustomBlockTest($this),
			new tests\BlockGetTest($this),
			new tests\LightFilterMinimumFreezeTest($this),
			new tests\ItemBlockRegisteredTest($this),
			new tests\BlockNameTest($this)
		];
	}
