...
class AsyncTaskMainLoggerTest extends Test{
	...
	public function run(){
		$this->getPlugin()->getServer()->getScheduler()->scheduleAsyncTask(new class($this) extends AsyncTask{

			/** @var bool */
			protected $success = false;

			public function __construct(AsyncTaskMainLoggerTest $complexData = null){
